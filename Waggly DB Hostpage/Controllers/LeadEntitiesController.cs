...
namespace Waggly_DB_Hostpage.Controllers
{
    public class LeadEntitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,dogName")] LeadEntity leadEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,dogName")] LeadEntity leadEntity)
        {
            if (id != leadEntity.Id)
            {
                return NotFound();
